...
class JanderListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by JanderParser#header.
    def enterHeader(self, ctx:JanderParser.HeaderContext):
        pass

    # Exit a parse tree produced by JanderParser#header.
    def exitHeader(self, ctx:JanderParser.HeaderContext):
        pass
